...
class ExpertsControllerTest < ActionController::TestCase
  ...
  test "should create expert" do
    assert_difference('Expert.count') do
      post :create, expert: { email: @expert.email, level: @expert.level, question_answered: @expert.question_answered, username: @expert.username }
    end
  ...
  test "should update expert" do
    patch :update, id: @expert, expert: { email: @expert.email, level: @expert.level, question_answered: @expert.question_answered, username: @expert.username }
    assert_redirected_to expert_path(assigns(:expert))
  end
